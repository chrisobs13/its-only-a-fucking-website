<h1>gulp-util <a href="https://npmjs.org/package/gulp-util"><img src="https://badge.fury.io/js/gulp-util.svg" alt="NPM version" /></a> <a href="https://travis-ci.org/gulpjs/gulp-util"><img src="https://travis-ci.org/gulpjs/gulp-util.svg?branch=master" alt="Build Status" /></a> <a href="https://coveralls.io/r/gulpjs/gulp-util"><img src="https://coveralls.io/repos/gulpjs/gulp-util/badge.png" alt="Coveralls Status" /></a> <a href="https://david-dm.org/gulpjs/gulp-util"><img src="https://david-dm.org/gulpjs/gulp-util.svg" alt="Dependency Status" /></a></h1>
...
<p>```javascript
var gutil = require(‘gulp-util’);</p>

<p>gutil.log(‘stuff happened’, ‘Really it did’, gutil.colors.cyan(‘123’));
gutil.beep();</p>

<p>gutil.replaceExtension(‘file.coffee’, ‘.js’); // file.js</p>
...
<p>Logs stuff. Already prefixed with [gulp] and all that. Use the right colors for values. If you pass in multiple arguments it will join them by a space.</p>
...
<p>```javascript
gulp.src(‘stuff/*.js’)
  .pipe(gutil.buffer(function(err, files){</p>
...
<p>var err = new gutil.PluginError({
  plugin: ‘test’,
  message: ‘something broke’
});</p>

<p>var err = new gutil.PluginError(‘test’, ‘something broke’);</p>

<p>var err = new gutil.PluginError(‘test’, ‘something broke’, {showStack: true});</p>

<p>var existingError = new Error(‘OMG’);
